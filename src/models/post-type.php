                ...
                'sections'  => [
                    ...
                    'regions'      => [
                        ...
                        'fields' => [
                            ...
                            'selectDefaultRegion' => [
                                'type'    => 'switcher',
                                'title'   => __( 'Select Default Region on Load', 'interactive-geo-maps' ),
                                'desc'    => __( 'Enable to auto-select the default or first region when the map loads.', 'interactive-geo-maps' ),
                                'default' => false,
                            ],
